...
STYLE="<style> table, td { border: 1px solid black; border-collapse: collapse; } td { width:24px; height:18px; text-align: 
center; } </style>"
...
INTERSECTING_POINTS_PER_LETTER="A=1,B=2,C=2,D=2,E=1,F=4,G=4,H=4,I=1,J=8,K=8,L=8,M=8,N=8,O=1,P=16,Q=16,R=16,S=16,T=16,U=1,V=32,W=
32,X=64,Y=64,Z=128"
